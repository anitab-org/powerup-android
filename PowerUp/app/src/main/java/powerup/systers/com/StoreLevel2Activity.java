...
public class StoreLevel2Activity extends AppCompatActivity {
    ...
    public void setAvatarClothes(int index){
        ...
        String clothImageName = "hs_dress_avatar";
    ...
    public void setAvatarAccessories(int index){
        ...
        String accessoryImageName = "hs_acc";
